        ...
        public SurecVeriModel<DataTable> Rapor(string DilID)
        {
            ...
            if (SModel.Sonuc.Equals(Sonuclar.Basarili))
            {
                ...
                SDataRapor.Veriler.Columns.AddRange(new DataColumn[] {
                    ...
                    new DataColumn("Transfer", Type.GetType("System.String")),
                    new DataColumn("Kurs(lar)", Type.GetType("System.String")),
                    new DataColumn("Etkinlik(ler)", Type.GetType("System.String")),
