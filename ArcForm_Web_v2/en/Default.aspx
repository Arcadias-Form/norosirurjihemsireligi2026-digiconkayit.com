<%@ Page Title="" Language="C#" MasterPageFile="~/en/en.master" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="ArcForm_Web_v2.en.Default" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="en_Content" runat="server">
    ...
    <asp:SqlDataSource runat="server" ID="OleDbOdemeTipiListesi" ConnectionString='<%$ ConnectionStrings:ArcForm_Web %>' ProviderName='<%$ ConnectionStrings:ArcForm_Web.ProviderName %>' SelectCommand="SELECT * FROM [OdemeTipiDilTablosu] WHERE [DilID] = 'en'"></asp:SqlDataSource>
</asp:Content>
