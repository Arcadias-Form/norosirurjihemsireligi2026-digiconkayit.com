<%@ Page Title="" Language="C#" MasterPageFile="~/tr/tr.master" AutoEventWireup="true" CodeBehind="BasariliKayit.aspx.cs" Inherits="ArcForm_Web_v2.tr.BasariliKayit" %>
            ...
            <div class="col-lg-12 text-center">
                ...
                <div style="color: white;">
                    ...
                    <asp:Panel ID="PnlKrediKarti" runat="server" Visible="false" CssClass="text-center">
                        ...
                        <p>
                            İhtiyacınız olabilecek her türlü yardım için <a href="mailto:test@arkadyas.com">test@arkadyas.org</a> iletişime geçebilirsiniz.
                        </p>
                    </asp:Panel>
                    ...
                    <asp:Panel ID="PnlBankaBilgisi" runat="server" CssClass="text-center" Visible="false">
                        ...
                        <p>Ödemenizi takip edebilmemiz için, dekontunuzu <a href="mailto:....@....">....@....</a> adresine sipariş numarası içerecek şekilde göndermeyi unutmayınız.</p>
                    </asp:Panel>
