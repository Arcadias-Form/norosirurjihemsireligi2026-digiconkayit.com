...
namespace VeritabaniIslemMerkeziBase
{
	public abstract class OdemeTipiTablosuIslemlerBase
	{
		...
		{
			VTIslem.SetCommandText("INSERT INTO OdemeTipiTablosu (GuncellenmeTarihi, EklenmeTarihi) VALUES (@GuncellenmeTarihi, @EklenmeTarihi)");
		...
		{
			VTIslem.SetCommandText("UPDATE OdemeTipiTablosu SET GuncellenmeTarihi=@GuncellenmeTarihi, EklenmeTarihi=@EklenmeTarihi WHERE OdemeTipiID=@OdemeTipiID");
			...
			try
			{
				SDataModel = new SurecVeriModel<OdemeTipiTablosuModel>{
					...
					Veriler = new OdemeTipiTablosuModel
					{
						...
						GuncellenmeTarihi = SModel.Reader.GetDateTime(1),
			...
			try
			{
				SDataModel = new SurecVeriModel<OdemeTipiTablosuModel>{
					...
					Veriler = new OdemeTipiTablosuModel{
						...
						GuncellenmeTarihi = Reader.GetDateTime(Baslangic + 1),
