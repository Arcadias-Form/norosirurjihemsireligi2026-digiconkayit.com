...
<asp:Content ID="Content2" ContentPlaceHolderID="tr_Content" runat="server">
    ...
    <asp:SqlDataSource runat="server" ID="OleDbOtelListesi" ConnectionString='<%$ ConnectionStrings:Norosirurjihemsireligi2026_Web %>' ProviderName='<%$ ConnectionStrings:Norosirurjihemsireligi2026_Web.ProviderName %>' SelectCommand="SELECT * FROM [OtelTablosu] WHERE OtelID IN (2,6) ORDER BY Sira"></asp:SqlDataSource>
